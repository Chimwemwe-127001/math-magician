  ...
  render() {
    return (
      <div className="btn-subgrid">
        ...
        <button type="button" onClick={() => this.props.clickHandler('%')}>%</button>
        <button type="button" className="orange" onClick={() => this.props.clickHandler('÷')}>÷</button>
        ...
        <button type="button" className="orange" onClick={() => this.props.clickHandler('x')}>x</button>
